...
base_path = '/Users/vaji/Documents/ProjectMealDeliveryJ1/ML4QS-G28/Data/run pocket (Zijie) 2024-06-12 20-17-28/'

# Names of the files
file_names = ['Accelerometer.csv', 'Gyroscope.csv', 'Linear Accelerometer.csv', 'Location.csv']
