...
def clean_data(df):
    ...
    # Determine the number of neighbors for LOF
    n_neighbors = min(50, len(df) - 1)
    contamination = min(0.03, 1.0 / len(df))
...
base_path = '/Users/vaji/Documents/ProjectMealDeliveryJ1/ML4QS-G28/Data/walk pocket (Lars) Measurement 05062024 1224 2024-06-06 11-18-28/'
